...
import svgPaths from "./svg-gdlbppenbe";
import { imgGroup } from "./svg-ocbbu";
...
export default function Year() {
  return (
    <div className="bg-white content-stretch flex flex-col items-start relative size-full" data-name="Year">
                ...
                <div className="content-stretch flex items-center justify-between relative size-full">
                  ...
                  <div className="bg-white h-[45.6px] relative rounded-[10px] shrink-0 w-[226.463px]" data-name="Container">
                    ...
                    <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex gap-[8px] items-start pb-[0.8px] pl-[4.8px] pr-[0.8px] pt-[4.8px] relative size-full">
                      <Wrapper additionalClassNames="w-[67.4px]">
                      ...
                      <Wrapper additionalClassNames="bg-[#00a63e] w-[58.775px]">
                      ...
                      <div className="absolute contents inset-[0_0.43%_11%_5.65%]" data-name="Group">
                        <div className="absolute contents inset-[0_0.43%_11%_5.65%]" data-name="Clip path group">
                          <div className="absolute contents inset-[15.75%_0.43%_11.67%_5.65%]" data-name="Group">
                            <Group>
                              <g id="Group">
                                <path d={svgPaths.p3acfd300} fill="url(#paint0_linear_1_4893)" fillOpacity="0.6" id="Vector" />
                                <path d={svgPaths.pee0740} id="Vector_2" stroke="var(--stroke-0, #2CA01C)" strokeWidth="2" />
                              </g>
                              <defs>
                                <linearGradient gradientUnits="userSpaceOnUse" id="paint0_linear_1_4893" x1="0.156051" x2="0.156051" y1="0.965226" y2="218.715">
                      ...
                      <div className="absolute contents inset-[0_0.43%_11%_5.65%]" data-name="Group">
                        <div className="absolute contents inset-[0_0.43%_11%_5.65%]" data-name="Clip path group">
                          <div className="absolute contents inset-[15.75%_0.43%_11.67%_5.65%]" data-name="Group">
                            <Group>
                              <g id="Group">
                                <path d={svgPaths.p3acfd300} fill="url(#paint0_linear_1_4877)" fillOpacity="0.6" id="Vector" />
                                <path d={svgPaths.pee0740} id="Vector_2" stroke="var(--stroke-0, #F97316)" strokeWidth="2" />
                              </g>
                              <defs>
                                <linearGradient gradientUnits="userSpaceOnUse" id="paint0_linear_1_4877" x1="0.156051" x2="0.156051" y1="0.965226" y2="218.715">
